      ...
      <table class="table table-bordered table-hover align-middle tabla-organizada">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo htmlspecialchars($alumno['tipo']); ?></td>
            <td>
              <a href="../modificaciones/editar_alumno.php?id=<?php echo urlencode($alumno['id_persona']); ?>" class="btn btn-warning btn-sm">Modificar</a>
              <a href="../modificaciones/eliminar_alumno.php?id=<?php echo urlencode($alumno['id_persona']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro que desea eliminar este alumno?');">Eliminar</a>
            </td>
          </tr>
          <?php } ?>
        </tbody>
