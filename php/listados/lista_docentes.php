        ...
        <tbody>
          <?php foreach ($docentes as $doc) { ?>
            <tr>
              ...
              <td><?= htmlspecialchars($doc['apellido']) ?></td>
              <td><?= htmlspecialchars($doc['tipo']) ?></td>
              <td>
              <a href="../modificaciones/editar_docente.php?id=<?php echo urlencode($doc['id_persona']); ?>" class="btn btn-warning btn-sm">Modificar</a>
              <a href="../modificaciones/eliminar_docente.php?id=<?php echo urlencode($doc['id_persona']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro que desea eliminar este docente?');">Eliminar</a>
            </td>
            </tr>
          <?php } ?>
        </tbody>
