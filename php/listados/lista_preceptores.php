      ...
      <table class="table table-bordered table-hover align-middle tabla-organizada">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="../modificaciones/editar_preceptor.php?id=<?php echo urlencode($preceptor['id_persona']); ?>" class="btn btn-warning btn-sm">Modificar</a>
              <a href="../modificaciones/eliminar_preceptor.php?id=<?php echo urlencode($preceptor['id_persona']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Seguro que desea eliminar este alumno?');">Eliminar</a>
            </td>
          </tr>
