...
<head>
  ...
  <style>
    ...
    .tabla-organizada thead {
      background: rgba(15, 15, 15, 0.7);
      color: #fff;
    }
    .tabla-organizada tbody tr:hover {
          ...
          <?php foreach ($secciones as $fila) { ?>
            <tr>
              ...
              <td class="text-center">
                <a href="../modificaciones/editar_seccion.php?id=<?= urlencode($fila['id_seccion']) ?>" class="btn btn-sm btn-warning me-2">Modificar</a>
                <a href="../modificaciones/eliminar_seccion.php?id=<?= urlencode($fila['id_seccion']) ?>" class="btn btn-sm btn-danger" onclick="return confirm('¿Seguro que quieres eliminar esta sección?');">Eliminar</a>
              </td>
            </tr>
          <?php } ?>
        </tbody>
